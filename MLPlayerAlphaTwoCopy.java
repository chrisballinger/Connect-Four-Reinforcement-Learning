...
public class MLPlayerAlphaTwoCopy
{
	...
	// Constructor.
	public MLPlayerAlphaTwoCopy(Player p)
	{
		thePlayer = p;
	}
	...
	public void play(int my_id) throws IOException,ClassNotFoundException
	{
		...
		if(mess.win == thePlayer)
		{
			...
			System.out.println("MLPlayerAlphaTwoCopy has won.");
		}
		else
		{
			sarsa(0, weights, x_i, x_ip1);	//reward 0 for loss
			System.out.println("MLPlayerAlphaTwoCopy has lost.");
		}
	...
	public static void main(String[] args)
	{
		...
		MLPlayerAlphaTwoCopy me = new MLPlayerAlphaTwoCopy(p);
		try
		{
			me.play(my_id);
		}
