...
public class MLPlayerAlphaOneCopy
{
	...
	double epsilon = 0.0f; // FOR TESTING!
	double eta = 0.3f;
	double gamma = 0.99f;
	...
	public void play(int my_id) throws IOException,ClassNotFoundException
	{
		...
		if(mess.win == thePlayer)
		{
			...
			System.out.println("MLPlayerAlphaOneCopy has won.");
		}
		else
		{
			sarsa(0, weights, x_i, x_ip1);	//reward 0 for loss
			System.out.println("MLPlayerAlphaOneCopy has lost.");
		}
